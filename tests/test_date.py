...
class TestDate(unittest.TestCase):
    ...
    def test_operations(self):
        ...
        dur91d = Duration(
            ...
            w=0,
            d=0,
            _anchor_start=Date(2024, 1, 3),
            _anchor_end=Date(2024, 4, 3),
        )
    ...
    def test_from_unix(self):
        ...
        good = {
            1711065600.0: datetime.datetime(2024, 3, 22, 0, 0, 0, 0, pytz.UTC),
            1426636800.0: datetime.datetime(2015, 3, 18, 0, 0, 0, 0, pytz.UTC),
            1372636800.0: datetime.datetime(2013, 7, 1, 0, 0, 0, 0, pytz.UTC),
            1470268800.0: datetime.datetime(2016, 8, 4, 0, 0, 0, 0, pytz.UTC),
            1745971200.0: datetime.datetime(2025, 4, 30, 0, 0, 0, 0, pytz.UTC),
            1940630400.0: datetime.datetime(2031, 7, 1, 0, 0, 0, 0, pytz.UTC),
            2108764800.0: datetime.datetime(2036, 10, 28, 0, 0, 0, 0, pytz.UTC),
            1856217600.0: datetime.datetime(2028, 10, 27, 0, 0, 0, 0, pytz.UTC),
            1644192000.0: datetime.datetime(2022, 2, 7, 0, 0, 0, 0, pytz.UTC),
            1684281600.0: datetime.datetime(2023, 5, 17, 0, 0, 0, 0, pytz.UTC),
            2104963200.0: datetime.datetime(2036, 9, 14, 0, 0, 0, 0, pytz.UTC),
            2015625600.0: datetime.datetime(2033, 11, 15, 0, 0, 0, 0, pytz.UTC),
            1745280000.0: datetime.datetime(2025, 4, 22, 0, 0, 0, 0, pytz.UTC),
            1548201600.0: datetime.datetime(2019, 1, 23, 0, 0, 0, 0, pytz.UTC),
            1263513600.0: datetime.datetime(2010, 1, 15, 0, 0, 0, 0, pytz.UTC),
            1244419200.0: datetime.datetime(2009, 6, 8, 0, 0, 0, 0, pytz.UTC),
            1436918400.0: datetime.datetime(2015, 7, 15, 0, 0, 0, 0, pytz.UTC),
            1199836800.0: datetime.datetime(2008, 1, 9, 0, 0, 0, 0, pytz.UTC),
            1589587200.0: datetime.datetime(2020, 5, 16, 0, 0, 0, 0, pytz.UTC),
            1217116800.0: datetime.datetime(2008, 7, 27, 0, 0, 0, 0, pytz.UTC),
            833241600.0: datetime.datetime(1996, 5, 28, 0, 0, 0, 0, pytz.UTC),
            528595200.0: datetime.datetime(1986, 10, 2, 0, 0, 0, 0, pytz.UTC),
            301449600.0: datetime.datetime(1979, 7, 22, 0, 0, 0, 0, pytz.UTC),
            174787200.0: datetime.datetime(1975, 7, 17, 0, 0, 0, 0, pytz.UTC),
            -83548800.0: datetime.datetime(1967, 5, 10, 0, 0, 0, 0, pytz.UTC),
            112147200.0: datetime.datetime(1973, 7, 22, 0, 0, 0, 0, pytz.UTC),
            -261878400.0: datetime.datetime(1961, 9, 14, 0, 0, 0, 0, pytz.UTC),
            94780800.0: datetime.datetime(1973, 1, 2, 0, 0, 0, 0, pytz.UTC),
            -203558400.0: datetime.datetime(1963, 7, 21, 0, 0, 0, 0, pytz.UTC),
            -83289600.0: datetime.datetime(1967, 5, 13, 0, 0, 0, 0, pytz.UTC),
        }
