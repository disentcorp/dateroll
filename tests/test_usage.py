    ...
    def test_ddhCases(self):
        ...
        self.assertEqual(
            ...
            durationModule.Duration(
                years=1, months=0, days=0, modified=False, debug=False
            ),
        )
        ...
        self.assertEqual(
            ddh("6m+3m+1y"),
            durationModule.Duration(
                years=1, months=9, days=0, modified=False, debug=False
            ),
        )
        self.assertEqual(
            ddh("2y-5m-4d"),
            durationModule.Duration(
                years=1, months=7, days=-4, modified=False, debug=False
            ),
        )
        self.assertEqual(
